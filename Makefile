...
# compilers
override CXX_FLAGS += -Wall -Wextra -std=c++11 -fopenmp
CXX_LIBS = -I./$(INC_DIR)
CXX=g++

override NVC_FLAGS += --compiler-options -Wall,-Wextra -std=c++11 -Wno-deprecated-gpu-targets -Xcompiler -fopenmp
NVC_LIBS = -I./$(INC_DIR)
NVC=nvcc

override LD_FLAGS += --compiler-options -Wall,-Wextra -std=c++11 -Wno-deprecated-gpu-targets -Xcompiler -fopenmp
